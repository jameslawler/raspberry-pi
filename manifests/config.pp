...
file { [ "/home/pi/scripts", "/home/pi/scripts/mount", "/home/pi/scripts/usb", "/home/pi/scripts/miniDLNA", "/home/pi/scripts/mirror" ]:
    ensure => "directory",
}
...
file { '/home/pi/scripts/mirror/mirror.sh':
   owner => 'pi',
   group => 'pi',
   mode => 0755,
   source => "puppet:///modules/scripts/mirror/mirror.sh",
}
